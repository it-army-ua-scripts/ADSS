...
declare -A localization=(
  ...
  ["УВАГА! ⚠️"]="WARNING! ⚠️"
  ["Є важливе повідомлення від команди."]="There is an important message from the team."
  ["Повний текст доступний у README."]="The full text is available in the README."
  ["Утіліти IT ARMY а також команда розвідки в повному складі залишаються вірними патріотами України, які працюють проти ворога кожен день."]="IT ARMY utilities and the full intelligence team remain loyal patriots of Ukraine who work against the enemy every day."
  ["Всі розвідники і розробники утіліт, які працювали з вами всі 4+ років, залишаються єдиними в своїй позиції, без винятку."]="All intelligence members and utility developers who have worked with you for 4+ years remain united in this position, without exception."
  ["Інформація про компрометацію нашої команди є ініціативою адміністратора ТГ-каналу, який, спираючись на непідтверджені зв’язки з МінЦифри, намагався отримати доступ до чутливого коду та конфігурації під виглядом необхідного аудиту, хоча багато років він цього аудиту не потребував."]="The information about our team being compromised is an initiative of the Telegram channel administrator who, citing unconfirmed ties to the Ministry of Digital Transformation, tried to obtain access to sensitive code and configuration under the guise of a necessary audit, although for many years he had not needed such an audit."
  ["Оскільки ця особа не підтвердила ані організацію, яку він представляє, ані мету своїх потреб, ми були вимушені відмовити задля безпеки."]="Since this person did not confirm either the organization he represents or the purpose of his request, we had to refuse for security reasons."
  ["Ми інформуємо вас через утіліти, бо не маємо доступу до офіційного каналу."]="We are informing you through the utilities because we do not have access to the official channel."
  ["Якщо ви сумніваєтеся в поточних цілях, ви завжди можете подивитися, куди спрямовано трафік."]="If you doubt the current targets, you can always check where the traffic is being directed."
  ["Ми просимо вас не зупиняти сервери, оскільки робота продовжується і від адміністратора ТГ каналу ви не отримаєте правдивої інформації."]="We ask you not to stop the servers, because the work continues and you will not receive truthful information from the Telegram channel administrator."
  ["Скоріше за все, ми будемо створювати новий канал. Очікуйте нову інформацію через утіліти."]="Most likely, we will create a new channel. Expect new information through the utilities."
  ["Дякуємо за довіру. Слава Україні!"]="Thank you for your trust. Glory to Ukraine!"
